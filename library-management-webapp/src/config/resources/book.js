export default {
    add: [
        ...
        { id: 3, name: "year", label: "Book Year: ", type: "number", placeholder: new Date().getFullYear(), min: 1900, max: new Date().getFullYear(), required: true  },
        { id: 4, name: "finePerDay", label: "Fine per day (€): ", type: "number", placeholder: 0.01, min: 0.01, max: 10.00, step: 0.01, required: true },
        ...
        { id: 8, name: "totalAmount", label: "Total Amount: ", type: "number", placeholder: 1, min: 1, max: 50, required: true }
    ],
    get: [
        ...
        { id: 3, name: "Year", label: "Book Year (Optional): ", type: "number", placeholder: new Date().getFullYear(), min: 1900, max: new Date().getFullYear(), required: false  },
